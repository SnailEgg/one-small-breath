...
`Below is an ordered list of key words and phrases. If the user mentions one of the key phrases, the assistant should respond with their number in the list, or 0 if no key words were mentioned. The key phrases are case-insensitive don't need to be spelled correctly.
...
6. "department of extinction affairs department" or "DoEAD"
